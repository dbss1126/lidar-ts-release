...
# Changes expose triangle contribution tensors through the autograd wrapper.
...
class _RasterizeTriangles(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            num_rendered, color, depth, radii, geomBuffer, binningBuffer, imgBuffer, scaling, max_blending, triangle_indicies_per_pixel, triangle_weights_per_pixel, num_contributors_per_pixel = _C.rasterize_triangles(*args)
        ...
        return color, radii, scaling, depth, max_blending, triangle_indicies_per_pixel, triangle_weights_per_pixel, num_contributors_per_pixel

    @staticmethod
    def backward(ctx, grad_out_color, _, __, grad_depth, _____, ______, ________, _________):
